...
public class TestStudentPersistence {
    private final static PostgreSQLContainer databaseContainer = new PostgreSQLContainer("postgres:11.1")
    ...
    public void setUp() {
        ...
        jdbi.inTransaction(handle -> handle.execute("DROP TABLE IF EXISTS STUDENT CASCADE;\n" +
